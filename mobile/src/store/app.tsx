...
interface State {
  systemInformation: Partial<SystemInformation>;
}

let AppContext = createContext({} as State);

//TODO: the initial ztate must be fetch from the backend//
...
const reducer = (state: any, action: any) => {
  switch (action.type) {
    case "updateSystemInformation":
      return { ...state, action }; // review this
  }
